...
$new=Get-Content "$root/Vivado/qr_video30_stage4/qr_video30_stage4.srcs/sources_1/bd/vivado/qr_ip1_bd.bd" -Raw | ConvertFrom-Json
...
if($new.design.components.ov7670_axis_0.reference_info.ref_name -ne 'ov7670_clean_sync_axis') {
    if($new.design.components.ov7670_axis_0.vlnv -ne 'xilinx.com:module_ref:ov7670_clean_sync_axis:1.0') {throw 'Wrong camera receiver'}
}
...
$rtl=Get-Content "$root/Vivado/qr_video30_stage4/qr_video30_stage4.gen/sources_1/bd/vivado/synth/qr_ip1_bd.v" -Raw
...
$vdma=Get-Content "$root/Vivado/qr_video30_stage4/qr_video30_stage4.gen/sources_1/bd/vivado/ip/qr_ip1_bd_axi_vdma_0_0/synth/qr_ip1_bd_axi_vdma_0_0.vhd" -Raw
