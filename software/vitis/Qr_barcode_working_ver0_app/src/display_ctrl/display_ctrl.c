...
**
*/
int DisplayInitialize(DisplayCtrl *dispPtr, XAxiVdma *vdma, UINTPTR vtcLookupKey, u32 dynClkAddr, u8 *framePtr[DISPLAY_NUM_FRAMES],
    u32 stride)
{
	int Status;
	int i;
    ...
    */
	 ...
	 */
	vtcConfig = XVtc_LookupConfig(vtcLookupKey);
