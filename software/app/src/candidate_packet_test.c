#include "candidate_packet_test.h"
...
#define CANDIDATE_TEST_OV7670_STARTUP_DELAY_US     100000U
 ...
 * diagnostic/QR frame.
 */
#define CANDIDATE_TEST_CAMERA_SETTLE_DELAY_US      1000000U
...
#define CANDIDATE_TEST_VDMA_WIDTH                  640U
#define CANDIDATE_TEST_VDMA_HEIGHT                 480U
#define CANDIDATE_TEST_VDMA_BPP                    3U

#define CANDIDATE_TEST_VDMA_STRIDE                 \
    (CANDIDATE_TEST_VDMA_WIDTH * CANDIDATE_TEST_VDMA_BPP)

#define CANDIDATE_TEST_VDMA_FRAME_BYTES            \
    (CANDIDATE_TEST_VDMA_STRIDE * CANDIDATE_TEST_VDMA_HEIGHT)

#define CANDIDATE_TEST_VDMA_GRAY_BYTES             \
    (CANDIDATE_TEST_VDMA_WIDTH * CANDIDATE_TEST_VDMA_HEIGHT)
...
static void dump_vdma_rgb_as_gray_uart(void)
{
    ...
    Xil_DCacheInvalidateRange(
        (INTPTR)frame_addr,
        CANDIDATE_TEST_VDMA_FRAME_BYTES
    );
    ...
    xil_printf(
        ...
        CANDIDATE_TEST_VDMA_WIDTH,
        CANDIDATE_TEST_VDMA_HEIGHT,
        CANDIDATE_TEST_VDMA_GRAY_BYTES
    );


    for (y = 0U;
         y < CANDIDATE_TEST_VDMA_HEIGHT;
         ++y) {

        for (x = 0U;
             x < CANDIDATE_TEST_VDMA_WIDTH;
             ++x) {

            offset =
                (y * CANDIDATE_TEST_VDMA_STRIDE) +
                (x * CANDIDATE_TEST_VDMA_BPP);
...
#error "QR_HW_VDMA_BASEADDR is required."
    ...
    usleep(
        CANDIDATE_TEST_OV7670_STARTUP_DELAY_US
    );
    ...
    usleep(
        CANDIDATE_TEST_CAMERA_SETTLE_DELAY_US
    );
    ...
    xil_printf(
        ...
        (unsigned int)CANDIDATE_TEST_VDMA_GRAY_BYTES
    );
