...
option(QR_FRAME_RECEIVER "QPP1 two-bank binary capture and independent Gray8 receiver" OFF)
option(QR_FRAME_RECEIVER_STALL_TEST "Diagnostic only: hold Gray8 CPU ownership for 120ms" OFF)
if(QR_FRAME_RECEIVER_STALL_TEST AND NOT QR_FRAME_RECEIVER)
    message(FATAL_ERROR "Stall test requires QPP1")
endif()
if(QR_FRAME_RECEIVER AND (QR_PIPELINE_TRACE OR NOT QR_PL_GUIDED OR NOT QR_CAMERA_CONDITIONED_PCLK))
...
set(QR_FRONTEND_MODE "61" CACHE STRING "Frontend diagnostic mode: 61=combined preprocessing, 13=no morphology, 12=adaptive only, 4=global threshold")
...
option(QR_CAMERA_CONDITIONED_PCLK "MMCM-conditioned 24MHz returned clock" OFF)
...
if(QR_CAMERA_CONDITIONED_PCLK AND (NOT QR_CAMERA_SOURCE_SYNC OR NOT QR_CAMERA_CLKRC STREQUAL "128"))
    message(FATAL_ERROR "Conditioned returned clock requires source-sync and CLKRC=128")
endif()
foreach(flag QR_PREVIEW_FUSED QR_PER_FRAME_LOGS QR_PL_PREVIEW QR_CAMERA_SOURCE_SYNC QR_CAMERA_COLORBARS QR_CAMERA_CONDITIONED_PCLK QR_CANDIDATE_AUDIT QR_PL_GUIDED QR_GUIDED_EARLY_DECODE QR_PIPELINE_TRACE QR_FRAME_RECEIVER QR_FRAME_RECEIVER_STALL_TEST QR_FALLBACK_EARLY_DECODE QR_ROUTE_AUDIT QR_FALLBACK_TEST)
    if(${flag})
