...
proc update_PARAM_VALUE.C_VSYNC_ACTIVE_HIGH { PARAM_VALUE.C_VSYNC_ACTIVE_HIGH } {
	# Procedure called to update C_VSYNC_ACTIVE_HIGH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_VSYNC_ACTIVE_HIGH { PARAM_VALUE.C_VSYNC_ACTIVE_HIGH } {
	# Procedure called to validate C_VSYNC_ACTIVE_HIGH
	return true
}

proc update_PARAM_VALUE.C_XCLK_DIV { PARAM_VALUE.C_XCLK_DIV } {
	# Procedure called to update C_XCLK_DIV when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_XCLK_DIV { PARAM_VALUE.C_XCLK_DIV } {
	# Procedure called to validate C_XCLK_DIV
	return true
}
...
proc update_MODELPARAM_VALUE.C_XCLK_DIV { MODELPARAM_VALUE.C_XCLK_DIV PARAM_VALUE.C_XCLK_DIV } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_XCLK_DIV}] ${MODELPARAM_VALUE.C_XCLK_DIV}
}

proc update_MODELPARAM_VALUE.C_VSYNC_ACTIVE_HIGH { MODELPARAM_VALUE.C_VSYNC_ACTIVE_HIGH PARAM_VALUE.C_VSYNC_ACTIVE_HIGH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_VSYNC_ACTIVE_HIGH}] ${MODELPARAM_VALUE.C_VSYNC_ACTIVE_HIGH}
}
