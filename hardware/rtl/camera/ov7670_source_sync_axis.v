...
module ov7670_source_sync_axis (
    ...
    BUFG pclk_buf (.I(cam_pclk),.O(pclk));
    ...
    always @(posedge aclk) begin
        if (!aresetn) begin
            capture_en<=0; stat_clear<=0; aw_hold<=0; w_hold<=0;
            ...
            if (aw_hold && w_hold && !s_axi_bvalid) begin
                ...
                if (awaddr!=0 || (wstrb[0] && wdata[1] && (clear_busy || stat_clear))) s_axi_bresp<=2;
