`timescale 1ns/1ps
module ov7670_source_sync_axis_tb;
    ...
    wire [1:0] bp,rp;
    wire [31:0] rd;
    ov7670_source_sync_axis dut (.aclk(aclk),.aresetn(resetn),.refclk100(refclk),
    ...
    initial begin
        ...
        #20000;
        read_reg('h10,32'h43414d33,0); read_reg('hc,32'h00020000,0);
        read_reg('h30,1,0);
