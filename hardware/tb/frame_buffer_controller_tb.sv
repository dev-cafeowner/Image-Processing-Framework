`timescale 1ns/1ps
module frame_buffer_controller_tb;
    ...
    frame_buffer_controller #(.INITIAL_ID(32'hfffffffe)) q(
    ...
    frame_buffer_address addr(.write_word(wa),.read_word(14'd9599),.write_enable(wren),.read_write_enable(1'b0),
